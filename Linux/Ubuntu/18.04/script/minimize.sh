...
#echo "==> Removing X11 libraries" <- which cant be done if you wanna have java installed
#apt-get -y purge libx11-data xauth libxmuu1 libxcb1 libx11-6 libxext6 libxau6 libxdmcp6
#echo "==> Removing other oddities"
#apt-get -y purge busybox-static command-not-found command-not-found-data \
    dmidecode dosfstools friendly-recovery hdparm info install-info installation-report \
    iso-codes krb5-locales language-selector-common laptop-detect lshw mlocate mtr-tiny \
    ncurses-term nplan ntfs-3g os-prober parted pciutils plymouth popularity-contest powermgmt-base \
    publicsuffix ssh-import-id \
