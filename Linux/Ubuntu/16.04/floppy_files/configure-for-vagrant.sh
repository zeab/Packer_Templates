...
#Exits out if set not to configure for vagrant
if [[ ! "$CONFIGURE_FOR_VAGRANT" =~ ^(true|yes|on|1|TRUE|YES|ON])$ ]]; then
  echo "Selected not to configure for vagrant...skipping"
  exit
fi


#From http://paweloczadly.github.io/devops/2014/09/05/packer-build-and-test-your-vm-images
##########
# Set up sudo
...
#SSH_USER=${OS_USERNAME:-vagrant}
#SSH_PASS=${OS_PASSWORD:-vagrant}
#SSH_USER_HOME=${OS_USER_HOME:-/home/${SSH_USER}}
